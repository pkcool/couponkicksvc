...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "addressId":null, "streetAddress1":"SAMPLE_TEXT", "streetAddress2":"SAMPLE_TEXT", "suburb":"SAMPLE_TEXT", "postalCode":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "stateProvince":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
